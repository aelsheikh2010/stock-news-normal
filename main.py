...
api_stock_key = "P7FEEGDXXECOBSTM"
NEWS_API_KEY = "1141cd33d2cf46378a5fa38ec79a72d8"
ACCOUNT_SID = "AC5e38c72883a39c7777692be00c4782bd"
AUTH_TOKEN = "6553bf7af922f629dd469d8dd4f269b9"
...
if abs(diff_percent) >= 1:
    ...
    response = requests.get(NEWS_ENDPOINT, params=news_prams)
    response.raise_for_status()
